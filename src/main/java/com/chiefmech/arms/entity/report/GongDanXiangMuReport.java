...
public class GongDanXiangMuReport {
	...
	private String txtChuChangDate;
	...
	public String getTxtFeiYong() {
		return txtFeiYong;
	}
	public void setTxtFeiYong(String txtFeiYong) {
