...
public interface ChengBaoGongSiDao {
	...
	public List<ChengBaoGongSi> getChengBaoGongSiList(@Param("item") ChengBaoGongSi query,
	...
	@Insert("insert into chengBaoGongSi(chengBaoGongSiId,chengBaoGongSiName) values(#{chengBaoGongSiId},#{chengBaoGongSiName})")
	...
	@Select("select * from chengBaoGongSi")
