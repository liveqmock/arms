...
public interface StoreDao {
	...
	@Insert("insert into store(StoreId,txtStoreBianHao,txtStoreName,ddlStoreSort,ddlStopFlag,txtRemarks) values(#{StoreId},#{txtStoreBianHao},#{txtStoreName},#{ddlStoreSort},#{ddlStopFlag},#{txtRemarks})")
	public int insertItem(Store item);

	@Update("update store set txtStoreBianHao=#{txtStoreBianHao},txtStoreName=#{txtStoreName},ddlStoreSort=#{ddlStoreSort},ddlStopFlag=#{ddlStopFlag},txtRemarks=#{txtRemarks} where StoreId=#{StoreId}")
