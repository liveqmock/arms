...
public interface RuKuDanDao {
	...
	@Insert("insert into rukudan(txtGuid,txtShopCode,txtBillNo,txtRuKuDate,txtSuppName,txtJingShouRen,ddlRuKuSort,txtRemarks,txtStatus) values(#{txtGuid},#{txtShopCode},#{txtBillNo},#{txtRuKuDate},#{txtSuppName},#{txtJingShouRen},#{ddlRuKuSort},#{txtRemarks},#{txtStatus})")
