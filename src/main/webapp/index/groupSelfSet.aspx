        ...
        <span class="titleSpan">(机构设置)</span> 
         ...
         <table   border="1" style="border-collapse:collapse;border:1px solid gray;width:700px;margin-top:2px;margin-bottom:2px;">
          ...
          <td colspan="6">
           ...
           <tr>
           <td>电话1:</td>
           <td> <input name="txtTel1" type="text" value="0755-23938888" maxlength="15" id="txtTel1" style="width:120px;" /> </td>
           <td>电话2:</td>
           <td> <input name="txtTel2" type="text" value="0755-23938888" maxlength="15" id="txtTel2" style="width:120px;" /> </td>
           <td>传真:</td>
           ...
           <tr>
           <td colspan="6">
           <textarea name="txtAdd" rows="2" cols="20" id="txtAdd" style="width:500px;">深圳市宝安区西乡大道34号(西乡大道与前进二路交汇处)</textarea>
           </td>
           </tr>
           <tr>
           <td>车牌号码前缀:</td>
