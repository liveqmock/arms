...
<body>
    <form name="form1" method="post" action="saleAfterWeiXiuLiRunDetail.aspx" id="form1">
<div>
<input type="hidden" name="__EVENTTARGET" id="__EVENTTARGET" value="" />
<input type="hidden" name="__EVENTARGUMENT" id="__EVENTARGUMENT" value="" />
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwUJMTczMjA4NzU2ZGTMyU7qJ3CgPR66xMW89jAJJsIr2Q==" />
</div>
...
//]]>
    ...
    <!--按钮区域start-->
     ...
     <!--数据展示 start-->
      ...
      <tr>
       <td rowspan="2">NO.</td>
       <td rowspan="2">维修单号</td>
       <td rowspan="2">协议单号</td>
       <td rowspan="2">服务顾问</td>
       <td rowspan="2">传送财务时间</td>
...
<div>
	...
	<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="B72F699A" />
	<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="/wEWDQKo/tOVCgKIo57tCQK358StCwLB84CvCAKUyP1yArPxpOcGArPx4HgCqsfv4gcC1s/8zgICzqiCGgLKiYZsAqmLicEFArzt6fYE0/cJzwVzAESd65BZZRLHzQSG5S8=" />
</div></form>
