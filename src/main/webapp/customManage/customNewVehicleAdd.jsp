...
<body>
	<form name="form1" method="post" id="form1">
		...
		<option selected="selected" value="Lexus雷克萨斯">Lexus雷克萨斯</option>
						...
						<td>
							<div id="cheLiangCheXi" style="border: none; width: 135px;">
		...
		<option selected="selected" value="RX270">RX270</option>
						...
						<td><span class="requireSpan">*</span>车身颜色：</td>
						<td><select name="ddlCheShenColor" id="ddlCheShenColor"
							style="width: 135px; border: none;">
					...
					<tr>
						...
						<td><input name="txtCheLiangChePaiHao" type="text"
							maxlength="8" id="txtCheLiangChePaiHao" /></td>
						<td><span class="requireSpan">*</span>车架号：</td>
						<td><input name="txtCheLiangCheJiaHao" type="text"
							maxlength="17" id="txtCheLiangCheJiaHao" onblur="checkVIN();" /></td>
						<td><span class="requireSpan">*</span>发动机号：</td>
						<td><input name="txtCheLiangFaDongJiHao" type="text"
							maxlength="20" id="txtCheLiangFaDongJiHao" /></td>
						<td><span class="requireSpan">*</span>变速箱号：</td>
						<td><input name="txtCheLiangBianSuXiangHao" type="text"
							maxlength="20" id="txtCheLiangBianSuXiangHao" /></td>
					</tr>
					<tr>
						<td><span class="requireSpan">*</span>投保日期：</td>
						<td><input name="txtBaoXianDate" type="text"
							id="txtBaoXianDate" class="easyui-datebox" /></td>
						<td><span class="requireSpan">*</span>制造日期：</td>
						<td><input name="txtZhiZaoDate" type="text"
							id="txtZhiZaoDate" class="easyui-datebox" /></td>
						<td><span class="requireSpan">*</span>购车日期：</td>
						<td><input name="txtGouCheDate" type="text"
							id="txtGouCheDate" class="easyui-datebox" /></td>
						<td>内装颜色：</td>
						<td><select name="ddlNeiZhuangYanSe" id="ddlNeiZhuangYanSe"
							style="width: 135px; border: none;">
					...
					<tr>
						<td>商检单号：</td>
						<td><input name="txtShangJianDanHao" type="text"
							id="txtShangJianDanHao" /></td>
						<td>合格证号：</td>
						<td><input name="txtHeGeZhengHao" type="text"
							id="txtHeGeZhengHao" /></td>
						<td>进口证号：</td>
						<td><input name="txtJinKouZhengHao" type="text"
							id="txtJinKouZhengHao" /></td>
						<td>车辆规格：</td>
						<td><input name="txtCheLiangGuiGe" type="text"
							id="txtCheLiangGuiGe" /></td>
					</tr>
					<tr>
						<td>车辆种类：</td>
						...
						<td><input name="txtCheLiangNextExaDate" type="text"
							id="txtCheLiangNextExaDate" class="inputCss easyui-datebox" /></td>
						<td></td>
	...
	<script language="javascript" type="text/javascript">
		...
		function saveCheck() {
			...
			if ($.trim($("#ddlCheLiangZhiZaoShang").val()) == "") {
				err += "车辆信息->车辆制造商不能为空！\n";
			}
			if ($.trim($("#ddlCheLiangCheXi").val()) == "") {
				err += "车辆信息->车系不能为空！\n";
			}
			if ($.trim($("#txtCheLiangCheXingDaiMa").val()) == "") {
				err += "车辆信息->车型代码不能为空！\n";
			}
			if ($.trim($("#txtCheLiangChePaiHao").val()) == "") {
				err += "车辆信息->车牌号不能为空！\n";
			}
			if ($.trim($("#txtCheLiangCheJiaHao").val()) == "") {
				err += "车辆信息->车架号不能为空！\n";
			}
			if ($.trim($("#txtCheLiangFaDongJiHao").val()) == "") {
				err += "车辆信息->发动机号不能为空！\n";
			}
			if ($.trim($("#txtCheLiangBianSuXiangHao").val()) == "") {
				err += "车辆信息->变速箱号不能为空！\n";
			}
