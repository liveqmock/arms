...
<body>
	<form name="form1" method="post"
		action="customNewAdd.action?custId=80e1c393-1e7e-4aed-a87f-298427632abf&amp;d=Tue+Jan+06+2015+08%3a14%3a39+GMT+0800"
		id="form1">
		<div>
...
//]]>
		...
		<div>
			...
			<input type="hidden" name="__VIEWSTATEGENERATOR"
				id="__VIEWSTATEGENERATOR" value="AA8E297A" />
		</div>
		...
		<div style="width: 900px;">
			...
			<div id="aDiv" style="margin: 2 0 0 5; display: none;">
				<br /> <span
					style="font-weight: bold; font-size: 12px; color: Red;">请先填写证件类型及证件号码</span>
				<table border="0" cellpadding="0" cellspacing="0" width="900px"
					...
					<tr>
						...
						<td style="width: 125px;"><input name="txtCustId" type="text"
							value="80e1c393-1e7e-4aed-a87f-298427632abf" id="txtCustId" /> <select
							name="ddlCustSort" id="ddlCustSort"
						...
						<td><input name="txtCheZhuName" type="text" value="唐洋"
							maxlength="100" id="txtCheZhuName" /></td>
						...
						<td><input name="txtCheZhuTel" type="text"
							value="13265821118" maxlength="12" id="txtCheZhuTel" /></td>
						<td>内线:</td>
					...
					<tr>
						...
						<td><input name="txtCheZhuMob" type="text"
							value="13265821118" maxlength="12" id="txtCheZhuMob" /></td>
					</tr>
					...
					<tr>
						...
						<td>子女数目：</td>
						<td><input name="txtCheZhuZiNvQty" type="text" value="0"
					...
					<tr>
						...
						<td colspan="3"><input name="txtCheZhuCardNo" type="text"
							value="23333333333" maxlength="20" id="txtCheZhuCardNo"
							onblur="checkCardNo();" style="width: 400px;" /> <a href="#"
							onclick="showCustInfo();">?</a></td>
					...
					<tr>
						...
						<td colspan="7">
							...
							<div id="cheZhu">
								...
								<select name="ddlCheZhuP"
									onchange="javascript:setTimeout('__doPostBack(\'ddlCheZhuP\',\'\')', 0)"
									id="ddlCheZhuP" style="border: none; width: 100px">
								...
								</select>省(直辖市) <select name="ddlCheZhuC"
									onchange="javascript:setTimeout('__doPostBack(\'ddlCheZhuC\',\'\')', 0)"
									id="ddlCheZhuC" style="border: none; width: 100px">
									<option value="">请选择</option>
								...
								</select>市(地区) <select name="ddlCheZhuA"
									onchange="javascript:setTimeout('__doPostBack(\'ddlCheZhuA\',\'\')', 0)"
									id="ddlCheZhuA" style="border: none; width: 100px">
									<option value="">请选择</option>
							...
							</div> <!--隐藏域 start--> <input name="txtCheZhuP" type="text"
							value="广东省" id="txtCheZhuP" style="display: none;" /> <input
							name="txtCheZhuC" type="text" value="深圳市" id="txtCheZhuC"
							style="display: none;" /> <input name="txtCheZhuA" type="text"
							value="宝安区" id="txtCheZhuA" style="display: none;" /> <!--隐藏域 end-->
						</td>
					</tr>
					<tr>
						<td><span class="requireSpan">*</span>车主地址：</td>
						<td colspan="7"><input name="txtCheZhuAdd" type="text"
							value="广东省深圳南山区海印长城1期4栋5C"
					...
					<tr>
						...
						<td>购车次数：</td>
						<td><input name="txtCheZheGouCheQty" type="text" value="1"
			...
			<div id="bDiv" style="margin: 2 0 0 5; display: none;">
				...
				<table border="0" cellpadding="0" cellspacing="0" width="900px"
					...
					<tr>
						...
						<td><input name="txtLianXiRenName" type="text" value="唐洋"
							maxlength="20" id="txtLianXiRenName" /></td>
						...
						<td><input name="txtLianXiRenTel" type="text"
							value="13265821118" maxlength="14" id="txtLianXiRenTel" /></td>
						<td><span class="requireSpan">*</span>联系人手机：</td>
						<td><input name="txtLianXiRenMob" type="text"
							value="13265821118" maxlength="14" id="txtLianXiRenMob" /></td>
					</tr>
					...
					<tr>
						...
						<td colspan="3"><input name="txtLianXiRenCardNo" type="text"
							value="5464454" maxlength="20" id="txtLianXiRenCardNo"
					...
					<tr>
						...
						<td colspan="7">
							<div id="lianXiRen">
								...
								<select name="ddlLianXiRenP"
									onchange="javascript:setTimeout('__doPostBack(\'ddlLianXiRenP\',\'\')', 0)"
									id="ddlLianXiRenP" style="border: none; width: 100px">
									<option value="">请选择</option>
									<option selected="selected" value="广东省">广东省</option>
									<option value="北京市">北京市</option>
									<option value="天津市">天津市</option>
								...
								</select>省(直辖市) <select name="ddlLianXiRenC"
									onchange="javascript:setTimeout('__doPostBack(\'ddlLianXiRenC\',\'\')', 0)"
									id="ddlLianXiRenC" style="border: none; width: 100px">
									<option value="">请选择</option>
									<option selected="selected" value="深圳市">深圳市</option>
									<option value="广州市">广州市</option>
									<option value="韶关市">韶关市</option>
								...
								</select>市(地区) <select name="ddlLianXiRenA" id="ddlLianXiRenA"
							...
							</div> <input name="txtLianXiRenP" type="text" value="广东省"
							id="txtLianXiRenP" style="display: none;" /> <input
							name="txtLianXiRenC" type="text" value="深圳市"
							id="txtLianXiRenC" style="display: none;" /> <input
							name="txtLianXiRenA" type="text" value="宝安区"
							id="txtLianXiRenA" style="display: none;" />
						</td>
					</tr>
					<tr>
						<td><span class="requireSpan">*</span>车主地址：</td>
			...
			<div id="cDiv" style="margin: 2 0 0 5; display: none;">
				<br /> <span
					style="font-weight: bold; font-size: 12px; color: Red;">一辆车只能属于一个客户</span>
				...
				<table border="0" cellpadding="0" cellspacing="0" width="700px"
					...
					<tr>
						...
						<td></td>
						<td></td>
						<td><a onclick=mdfCheLiangInfo(
							'b3a58fd0-467d-41b1-8b60-e682224c4519')  class="easyui-linkbutton">修改车辆</a>
						</td>
					</tr>
			...
			<div align="center" id="btnBottomDiv">
				...
				<a onclick="return saveCheck(1);" id="lnkMdf"
					class="easyui-linkbutton"
					href="javascript:__doPostBack('lnkMdf','')">修改</a> <a
	...
	<script language="javascript" type="text/javascript">
         ...
         function mdfCheLiangInfo(vehicleId) {
             location.href = "customNewVehicleAdd.action?vehicleId="+vehicleId+"&d="+new Date();
             return false;
         }

         //车辆资料新增
         function addVehicleId() {            
             location.href = "customNewVehicleAdd.action?custId=80e1c393-1e7e-4aed-a87f-298427632abf&d=" + new Date();
             return false;
         }
