...
<div>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function addNewCustInfo(id, title) {
            z = window.open('../customManage/customNewAdd.aspx?&d=' + new Date(), title, 'height=600,width=970,top=80,left=80,toolbar=no,menubar=no,scrollbars=no,resizable=no,location=n o, status=no')
            z.focus();
        }
    ...
    <script language="javascript" type="text/javascript" >
        ...
        function custInfoMdf(index) {
           ...
           // parent.winopen('../customManage/customDetailAdd.aspx?custId=' + cusId + "&d=" + new Date(), '[' + cheZhuName + ']客户信息修改', 970, 600, true, true, false);
            ...
            var href = "customNewAdd.aspx?custId=" + cusId + "&d=" + new Date()
