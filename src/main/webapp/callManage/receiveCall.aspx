...
<body>
    <form name="form1" method="post" action="receiveCall.aspx?d=Tue+Jan+06+2015+08%3a32%3a31+GMT+0800" id="form1">
<div>
<input type="hidden" name="__EVENTTARGET" id="__EVENTTARGET" value="" />
<input type="hidden" name="__EVENTARGUMENT" id="__EVENTARGUMENT" value="" />
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwUKMTk3MjI1NjczN2Rkmm/aH2N8nUqV+jdZIkNumO5HNhs=" />
</div>
...
//]]>
        ...
        <td id="tab3" style="width:100px;cursor:pointer;background-color:Gray;color:White;text-align:center;">已收信息</td>
      ...
      >
		<thead>
			<tr>
                ...
                <th  data-options="field:'userName',width:120" sortable="true">发送人</th>
                ...
                <th  data-options="field:'readDate',width:120" sortable="true">阅读时间</th>
                <th  data-options="field:'contents',width:200" sortable="true">内容</th>                  
            </tr>
		</thead>
	</table> 
  ...
  <div  id="search" style="display:none;">
    <table border='0' >
     ...
     <td>发送人:</td>
     <td><input name="txtSendUser" type="text" maxlength="20" id="txtSendUser" style="width:120px;" /></td>
     <td>接收人:</td>
     <td><input name="txtReceUser" type="text" maxlength="20" id="txtReceUser" style="width:120px;" /></td>     
  
     </tr>
     <tr>
     <td>阅读时间:</td><td><input name="txtReadDateStart" type="text" id="txtReadDateStart" class="inputCss easyui-datebox" style="width:100px;" /> </td>
     <td>至</td><td><input name="txtReadDateEnd" type="text" id="txtReadDateEnd" class="inputCss easyui-datebox" style="width:100px;" /></td>
     <td>互动内容:</td>
     <td>
...
<div>
	...
	<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="7B9A302E" />
	<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="/wEWDQL/1Na2AgLAn+vmDAKfluDwDwKa7byuAgKm4eRsAqXmxeMIAtTtma4MArafk/YGAvHhnqMOAv7+uqMDAtTtsbQGAtL50r4DAqmLicEFK/UO+bsssQucJCGz3lEc0+R1pBw=" />
</div></form>
    ...
    <script language="javascript" type="text/javascript" >
        ...
        function billShow(index) {
            ...
            if (callId != "") {
                parent.winopen('../callManage/callShowByCallId.aspx?callId=' + callId + '&d=' + new Date(), '互动', 800, 610, true, true, false);
            }
        }
