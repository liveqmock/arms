...
<body>
 ...
 <form name="fmSearch" method="post" id="fmSearch">
		<table id="searchPanel" class="searchPanel" style="display: none;">
			<tr>
			 <td>发送时间:</td><td><input name="txtSendDate" type="text" id="txtSendDate" class="inputCss easyui-datebox" style="width:100px;" /> </td>
     <td>至</td><td><input name="txtSendDateEnd" type="text" id="txtSendDateEnd" class="inputCss easyui-datebox" style="width:100px;" /></td>
     <td>主送人:</td>
     <td><input name="hidToUserName" type="text" maxlength="20" id=hidToUserName style="width:120px;" /></td>     
     <td>互动内容:</td>
     <td>
     <input name="txtRemarks" type="text" maxlength="50" id="txtRemarks" style="width:120px;" />
     </td>	
			</tr>
		<tr>
    ...
    <table id="mydg" class="easyui-datagrid"
		data-options="url:'queryMail.action',
						   rownumbers:true,
						   singleSelect:true,
						   toolbar:'#toolbar',
						   pagination:true">
			...
			<table border="0">
				<tr>
					...
					<td><input class="easyui-validatebox" name="hidToUserName"
						type="text" id="hidToUserName" style="width: 400px;background:#FFF;" readonly="readonly" /></td>
				</tr>
				<tr>
					<td align="right"><span class="requireSpan">*&nbsp;</span>抄送人:</td>
					<td><input class="easyui-validatebox" name="hidCCUserName"
						type="text" id="hidCCUserName" style="width: 400px;background:#FFF;" readonly="readonly" /></td>
				</tr>
				<tr>
				<td align="right"><span class="requireSpan">*&nbsp;</span>发送时间:</td>
					<td><input class="easyui-validatebox" name="txtSendDate"
						type="text" id="txtSendDate" style="width: 400px;background:#FFF;" readonly="readonly"/></td>
				</tr>
				<tr>
