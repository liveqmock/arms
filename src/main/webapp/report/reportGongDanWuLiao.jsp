...
<body>
	<table border="0" style="width: 100%;">
		<tr>
			<td class="titlebg"><span>报表管理</span> <span class="titleSpan">(工单维修物料清单)</span>
			</td>
		</tr>
	</table>
	<div id="searchPanel" style="display: block;">
		<form name="fmSearch" method="post"
			action="queryGongDanWuLiaoReport.action" id="fmSearch" class="searchform">
			<table border='0' id="searchTb">
				<tr>
					...
					<td><input name="txtWuLiaoCode" type="text"
						class="easyui-textbox" maxlength="10" id="txtWuLiaoCode"
						style="width: 100px;" /></td>
					<td>物料名称:</td>
					<td><input name="txtWuLiaoName" type="text"
						class="easyui-textbox" maxlength="10" id="txtWuLiaoName"
						style="width: 100px;" /></td>
					<td>&nbsp;</td>
...
<table id="mydg" class="easyui-datagrid"
		data-options="url:'queryGongDanWuLiaoReport.action',rownumbers:true,singleSelect:true,toolbar:'#toolbar',pagination:false">
		<thead>
			<tr>
				<th width="100" data-options="field:'txtRuChangDate'">入厂时间</th>
				<th width="150" data-options="field:'txtWuLiaoCode'">物料编号</th>
				<th width="200" data-options="field:'txtWuLiaoName'">物料名称</th>
				<th width="250" data-options="field:'txtSuppName'">供应商</th>
				<th width="100" data-options="field:'txtQty'">领用数量</th>
				<th width="100" data-options="field:'txtSalePrice'">销售价</th>
				<th width="100" data-options="field:'txtChengBenJia'">成本价</th>
				<th width="80" data-options="field:'ddlSuoSuGongDuan'">所属工段</th>
...
<script type="text/javascript">
		...
		function doSearch() {
			$("#fmSearch").form('submit', {
				url : "queryGongDanWuLiaoReport.action",
		...
		function exportExcel() {
			$("#fmSearch").form('submit', {
				url : "exportGongDanWuLiaoReport.action",
