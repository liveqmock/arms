...
Sys.Res={
"urlMustBeLessThan1024chars":"嗱癠�舺�錗 url '� 1024 *W&",
"argumentTypeName":"<
/�	{媱
�",
"methodRegisteredTwice":"拐 {0} 蛳�",
"cantSetIdAfterInit":"�嗾(d鵤
緉 ID ^'",
"cantBeCalledAfterDispose":"嗾(�>K(",
"componentCantSetIdAfterAddedToApp":"(啮螓�0 Application 鵤嗾緉啮� ID ^'",
...
/	H剓�	H剓�
�",
"historyInvalidHistorySettingCombination":"嗾( ScriptManager.EnableHistory : true � enableHistory 緉: false",
"stateMustBeStringDictionary":"�鵤挲w	 null 學&2W�",
"boolTrueOrFalse":"<舺:truefalse",
"scriptLoadFailedNoHead":"ScriptLoader 丅ub+ \u003chead\u003e C ",
"stringFormatInvalid":"<W&2郒",
"referenceNotFound":"~
0啮{0}",
"enumReservedName":"{0}/
�(\�><
...
"propertyUndefined":"{0}
/^'�	W�",
"historyCannotEnableHistory":"嗾(�K緉 enableHistory",
"eventHandlerInvalid":"*� Sys.UI.DomEvent.addHandler 拐麪�",
"scriptLoadFailedDebug":",{0}*隣}骼�:\r\n 
锟顒飫\r\n ,�(IE)(丕緉/(>:�*,飫�\r\n :� Sys.Application.notifyScriptLoaded() �(",
"propertyNotWritable":"{0}
/餀刕'",
"enumInvalidValueName":"鶐�><{0}
/	H�
�",
"controlAlreadyDefined":"�C sT",
"addHandlerCantBeUsedForError":"
�(d拐麪飲鰟��9:緉 window.onerror ^'",
"namespaceContainsObject":"鵤 {0} 騒(v
/}
z�",
"cantAddNonFunctionhandler":"嗾麪
/齪��",
"invalidNameSpace":"<
/	H剗
z��&",
"notAnInterface":"<
/	H劌�",
"eventHandlerNotFunction":"徟{:齪",
"propertyNotAnArray":"{0}
/p腲'",
"typeRegisteredTwice":"{� {0} 蛳�镥驓I唟�!欼{媱,圅稞驙}熰稞/(
宧舭�-�9喚n",
"cantSetNameAfterInit":"�嗾(d鵤
緉
館'",
"historyMissingFrame":":�嗱癠燒( IE -w\(ub舺w	�* iFrame C 錍 � id__historyFrame�*�title邂W&2聀分v榲(6椼
� Sys.Application._onIFrameLoad() 剈b( ScriptManager 
 EnableHistory 緉: true镥Z0���",
"appDuplicateComponent":"嗾w	� ID{0}�$*啮麪0�(�",
"historyCannotAddHistoryPointWithHistoryDisabled":"臩 enableHistory 緉: true 鯩爢蝣艄",
"appComponentMustBeInitialized":"舺H�啮6M�冹麪0 Application 鵤",
"baseNotAClass":"<
/{",
"methodNotFound":"~
0
:{0}劰�",
"arrayParseBadFormat":"<舺/p膭	HW&2h:b兣{�[�4v�]�>",
"stateFieldNameInvalid":"�W�
�
�+鸘=W&",
"cantSetId":"嗾(d鵤
緉 ID ^'",
"historyMissingHiddenInput":":�嗱癠燒( Safari 2 -w\(ub舺w	 id :__history剱蠐eC ",
"stringFormatBraceMismatch":"<W&2+
9M勬'祺�'祺",
"enumValueNotInteger":"�>欼挲+tp<",
"propertyNullOrUndefined":"嗾緉{0}刕'�:冊迒 null <",
"argumentDomNode":"<舺: DOM C �,偣",
"componentCantSetIdTwice":"嗾!緉啮� ID ^'",
"createComponentOnDom":"鶐
/L:勀�<舺: null",
"createNotComponent":"{0} 
� Sys.Component >",
"createNoDom":"鶐孡:<
�: null",
"cantAddWithoutId":"嗾麪�	 ID 勀�",
"badTypeName":"<
/@鑼{媱
�
�/軾W",
"argumentInteger":"<舺:tp",
"scriptLoadMultipleCallbacks":",{0}+� Sys.Application.notifyScriptLoaded() �*(闍��*(",
"invokeCalledTwice":"嗾( invoke !",
"webServiceFailed":"
拐{0}1%v���: {1}",
...
"controlCantSetId":"嗾(
緉 ID ^'",
"formatBadFormatSpecifier":"<�&郒",
"webServiceFailedNoMsg":"
拐{0}1%",
"argumentDomElement":"<舺: DOM C ",
"invalidExecutorType":"嗾� {0} -�	H� Sys.Net.WebRequestExecutor",
"cannotCallBeforeResponse":"responseAvailable : false 鲟�( {0}",
"actualValue":"濫</ {0}",
"enumInvalidValue":"{0}鶐�> {1} 
/	H�<",
"scriptLoadFailed":"嗾爙,{0}",
"parameterCount":"聀
9M",
"cannotDeserializeEmptyString":"嗾蛷zW&2",
"formatInvalidString":"揺W&2�<
cn",
"invalidTimeout":"<舺'�I庼",
"cannotAbortBeforeStart":"gLh*/嗾-b",
"argument":"<
(��魠",
"cannotDeserializeInvalidJson":"嗾蛷pn*鶖�	H� JSON",
"invalidHttpVerb":"httpVerb 
n:zW&2 null W&2",
"nullWebRequest":"嗾(&	 null webRequest � executeRequest",
"eventHandlerInvalid":"*� Sys.UI.DomEvent.addHandler 拐麪�",
"cannotSerializeNonFiniteNumbers":"嗾�郟p",
"argumentUndefined":"<
�/*欼�",
"webServiceInvalidReturnType":"
拐{0}赞嗋H{�剓�: {1}",
"servicePathNotSet":"*緉 Web 
飫",
"argumentTypeWithTypes":"{�{0}匇a嗾lb:{�{1}",
"cannotCallOnceStarted":"/�嗾( {0}",
"badBaseUrl1":"� URL 
+ ://",
"badBaseUrl2":"� URL 
+��* /",
"badBaseUrl3":"(� URL -~
0��* /",
"setExecutorAfterActive":"嗾(gLh蚶;K鵹跮緉",
"paramName":"聀
: {0}",
"cannotCallOutsideHandler":"嗾(�剫���( {0}",
"cannotSerializeObjectWithCycle":"嗾�P^'-w	(匇a",
"format":"�苰-	�y�<郒",
"assertFailedCaller":"��1%: {0}\r\nMn: {1}",
"argumentOutOfRange":"殑聀騾�	H<��",
"webServiceTimedOut":"
拐{0}騾�",
"notImplemented":"拐蚛*灠",
"assertFailed":"��1%: {0}",
"invalidOperation":"鵤凷M�逋\郒",
"breakIntoDebugger":"{0}\r\n\r\n/&-説?"
};
