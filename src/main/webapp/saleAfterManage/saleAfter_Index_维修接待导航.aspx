...
<div id="content" style="border-left:1px solid gray;border-right:1px solid gray;border-bottom:1px solid gray;margin:0px;height:500px;">
 ...
 <script language="javascript" type="text/javascript" >
     ...
     function show(sort) {
         ...
         if (sort == 1) { $("#" + tmp).removeClass(); $("#a").addClass("tabs_active"); tmp = "a"; url = "saleAfterWeiXiuJieDai.action?saleAfterWeiXiuGuid=&cusId=&vehicleId=3901db63-9379-4ef2-8ace-67bf172a5559&carId=&yuYueId="; $(".titleSpan1").html("(维修接待)"); }
