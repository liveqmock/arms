...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
</div>
...
//]]>
    ...
    <div style="margin-left:5px;margin-top:5px;">        
       <table border="0"   cellpadding="0" cellspacing="0" width="900px" >
        ...
        <input name="txtCusId" type="text" value="b1af3308-b52d-4d23-83a0-27d6e689329b" id="txtCusId" style="display:none;" />
        <input name="txtVehicleId" type="text" value="b1af3308-b52d-4d23-83a0-27d6e689329b" id="txtVehicleId" style="display:none;" />
        ...
        <input name="txtChePaiHao" type="text" value="粤1WT45" maxlength="10" id="txtChePaiHao" /> </td>
        <td  style="width:90px;"><span class="requireSpan">*</span>里程:</td>
        <td><input name="txtLiCheng" type="text" value="29794" maxlength="10" id="txtLiCheng" class="easyui-numberbox" /> </td>
        <td  style="width:90px;"><span class="requireSpan">*</span>油量:</td>
        <td><input name="txtYouLiang" type="text" value="0.50" maxlength="4" id="txtYouLiang" class="easyui-numberbox" data-options="min:0,max:1,precision:2" /> </td>
        <td  style="width:90px;">购车日期:</td>
        <td><input name="txtGouCheDate" type="text" value="2013-9-8" maxlength="10" id="txtGouCheDate" class="easyui-datebox" style="width:136px;" /> </td>
        </tr>
         <tr>
        <td>VIN:</td>
        <td><input name="txtVin" type="text" value="JTJZA11A8D2033028" maxlength="17" id="txtVin" /> </td>
        <td>发动机号:</td>
        <td><input name="txtFaDongJiHao" type="text" value="1AR 0950832" maxlength="18" id="txtFaDongJiHao" /> </td>
        <td>厂家品牌:</td>
        <td><input name="txtChangJiaPinPai" type="text" value="雷克萨斯" maxlength="10" id="txtChangJiaPinPai" /> </td>
        <td>车系名称:</td>
        <td><input name="txtCheXiName" type="text" value="RX270" maxlength="10" id="txtCheXiName" /> </td>
        </tr>
         <tr>
        <td>颜色:</td>
        <td><input name="txtChenShenYanSe" type="text" value="彩晶黑" maxlength="10" id="txtChenShenYanSe" /> </td>
        <td>AT/MT:</td>
        <td><input name="txtAT" type="text" maxlength="2" id="txtAT" /> </td>
        <td>车型代码:</td>
        <td><input name="txtCheXingDaiMa" type="text" value="AGL10L-AWTGKW" maxlength="20" id="txtCheXingDaiMa" /> </td>
        <td>客户类别:</td>
        ...
        <tr>
        <td>车主名:</td>
        <td><input name="txtCheZhuName" type="text" value="蔡国胜" maxlength="50" id="txtCheZhuName" /> </td>
        <td>车主电话:</td>
        <td><input name="txtCheZhuTel" type="text" value="13902955893" maxlength="20" id="txtCheZhuTel" /> </td>
        <td>车主手机:</td>
        <td><input name="txtCheZhuMob" type="text" value="13902955893" maxlength="11" id="txtCheZhuMob" /> </td>
        <td>会员等级:</td>
        <td><input name="txtHuiYuanDengJi" type="text" value="阳光会员" maxlength="10" readonly="readonly" id="txtHuiYuanDengJi" /></td>
        </tr>
         <tr>
        <td>联系人:</td>
        <td><input name="txtLianXiRenName" type="text" value="蔡国胜" maxlength="20" id="txtLianXiRenName" /> </td>
        <td>联系人电话:</td>
        <td><input name="txtLianXiRenTel" type="text" value="13902955893" maxlength="20" id="txtLianXiRenTel" /> </td>
        <td>联系人手机:</td>
        <td><input name="txtLianXiRenMob" type="text" value="13902955893" maxlength="11" id="txtLianXiRenMob" /> </td>
        <td>会员卡号:</td>
        <td><input name="txtHuiYuanHao" type="text" value="32001060" maxlength="10" readonly="readonly" id="txtHuiYuanHao" /></td>
        </tr> 

        <tr>
        <td>联系地址:</td>
        <td colspan="7">
        <input name="txtLianXiRenAdd" type="text" value="宝城翻身路149A2栋210" maxlength="100" id="txtLianXiRenAdd" style="width:829px;" />
        </td>
        </tr>
        ...
        <tr>
        <td>维修单号:</td>
        <td><input name="txtBillNo" type="text" value="JDD20150105028" readonly="readonly" id="txtBillNo" /> </td>
        <td><span class="requireSpan">*</span>协议单号:</td>
        <td><input name="txtXieYiBillNo" type="text" value="SL0X15013638" maxlength="12" id="txtXieYiBillNo" /> </td>
        <td><span class="requireSpan">*</span>入厂时间:</td>
        <td><input name="txtRuChangDate" type="text" value="2015-1-5 15:15:50" id="txtRuChangDate" /> </td>
        <td><span class="requireSpan">*</span>预出厂时间:</td>
        <td><input name="txtYuChuChangDate" type="text" value="2015-01-06 15:15:50" id="txtYuChuChangDate" class="easyui-datetimebox" style="width:136px;" /> </td>
        </tr> 
        <tr>
        <td>服务顾问:</td>
        <td><input name="txtFuWuUserId" type="text" value="刘杰生" maxlength="10" id="txtFuWuUserId" /> </td>
	...
	<option selected="selected" value="定保">定保</option>
...
<div>
	...
	<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="" />
</div></form>
