 ...
 <script language="javascript" type="text/javascript" >
	(function ($) {
     ...
     function show(sort) {
         ...
         if (sort == 1) { $("#" + tmp).removeClass(); $("#a").addClass("tabs_active"); tmp = "a"; url = "saleAfter_weiXiuJieDai.aspx?saleAfterWeiXiuGuid=d4e10073-1054-4c86-b552-f44623513d0b&cusId=&vehicleId=&carId=&yuYueId="; $(".titleSpan1").html("(维修接待)"); }
