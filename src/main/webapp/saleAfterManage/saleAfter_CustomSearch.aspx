...
<div>
    ...
    <script language="javascript" type="text/javascript" >
        ...
        function addCheLiangInfo() {
            ...
            z = window.open('../customManage/customNewAdd.aspx?d=' + new Date(), '新增客户信息', 'height=600,width=970,top=80,left=80,toolbar=no,menubar=no,scrollbars=yes,resizable=yes,location=no, status=no')
            z.focus();
            return false;
        }
