...
<body>
    <form name="form1" method="post" action="saleAfterGongDanManage.action?tabId=6" id="form1">
<div>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function billShow(index) {
            ...
            if (thisGuid != "" && thisGuid !=undefined) {
                //parent.winopen('../saleAfterManage/saleAfterIndex.action?tabId=6 &saleAfterWeiXiuGuid=' + thisGuid + '&d=' + new Date(), '维修工单', 990, 600, true, true, false);
                z = window.open('../saleAfterManage/saleAfterIndex.action?tabId=6 &saleAfterWeiXiuGuid=' + thisGuid + '&d=' + new Date(), '维修工单', 'height=600,width=990,top=100,left=50,toolbar=no,menubar=no,scrollbars=yes,resizable=yes,location=no,status=no');
                z.focus();
            }
          }
