...
<input type="checkbox" onClick="checkPrintZhuXiuRen(this)" checked="true" />打印主修人
	...
	<tr>
       ...
       <table border="0" cellpadding="0" cellspacing="0" width="730px" style="margin-left:15px;" >
        <tr>
          <td   align="center" style="font-size:16px;height:23px;font-weight:bold;vertical-align:top;text-align:center;">深圳市八路通汽车服务连锁机构西乡店维修结算单
          </td>
          </tr>
          <tr>
           <td   align="center" style="font-size:16px;height:23px;font-weight:bold;vertical-align:top;text-align:center;">深圳市八路通汽车服务连锁机构西乡店(人保直销客户专用)结算单
          </td>
         </tr>
         ...
         <td>
           <table border="0" cellpadding="0" cellspacing="0" width="100%"  style="margin-left:10px;margin-right:10px;border-collapse:collapse;" >
            <tr>
            <td width="150px" style="border:2px solid black;padding-left:2px;font-size:14px;">服务顾问:&nbsp;</td>
            <td  width="160px"  style="border:2px solid black;padding-left:3px;font-size:14px;">客户确认:</td>
            <td width="200px"></td>
            <td  height="60px" style="font-size:12px;" >工单号:&nbsp; <br />
              车牌号码:&nbsp;<br />实际单号:&nbsp;</td>
         ...
         <!--客户信息 start-->
           ...
           <tr>
           <td rowspan="2" style="border-bottom:1px solid black;border-right:1px dotted black;">客户信息</td>
           <td style="border-bottom:1px dotted black;border-right:1px dotted black;">客户名称:</td>
           <td colspan="2"  style="border-bottom:1px dotted black;border-right:1px dotted black;">&nbsp;</td>
           ...
           <tr>
           <td  style="border-bottom:1px solid black;border-right:1px dotted black;">客户电话:</td>
           <td  style="border-bottom:1px solid black;border-right:1px dotted black;" >&nbsp;</td>
           <td  style="border-bottom:1px solid black;border-right:1px dotted black;">客户类别:</td>
           <td  style="border-bottom:1px solid black;border-right:1px dotted black;">&nbsp;</td>
           <td  rowspan="1" style="border-bottom:1px solid black;border-right:1px dotted black;">联系地址:</td>
           <td colspan="3"  style="border-bottom:1px solid black;">&nbsp;</td>
           </tr>
           <tr>
           <td rowspan="3"  style="border-right:1px dotted black;">车辆信息</td>
           <td style="border-bottom:1px dotted black;border-right:1px dotted black;">品牌:</td>
           <td style="border-bottom:1px dotted black;border-right:1px dotted black;">&nbsp;</td>
           ...
           <td colspan="3"  style="border-bottom:1px dotted black;border-right:1px dotted black;">&nbsp;JTHBE1BL4C5009040</td>
           </tr>
           <tr>
           ...
           <td  style="border-bottom:1px dotted black;border-right:1px dotted black;">发动机号:</td>
           <td colspan="3"  style="border-bottom:1px dotted black;border-right:1px dotted black;">&nbsp;2GR 8756496</td>
           <td  style="border-bottom:1px dotted black;border-right:1px dotted black;">承保公司:</td>
           <td  style="border-bottom:1px dotted black;">&nbsp;</td>
           </tr>
            <tr>
           <td  style="border-bottom:1px dotted black;border-right:1px dotted black;">注册日期:</td>
           <td  style="border-bottom:1px dotted black;border-right:1px dotted black;">&nbsp;</td>
           <td  style="border-bottom:1px dotted black;border-right:1px dotted black;">年审到期:</td>
           <td colspan="3"  style="border-bottom:1px dotted black;border-right:1px dotted black;">&nbsp;</td>
           <td  style="border-bottom:1px dotted black;border-right:1px dotted black;">保险到期:</td>
           <td  style="border-bottom:1px dotted black;">&nbsp;</td>
           </tr>
           <tr>
        ...
        <td>
         <!--下次保养提醒 start-->
          <span style='font-weight:bold;font-size:15px;padding-top:3px;'>下次保养里程: &nbsp; &nbsp;&nbsp;下次保养日期:</span>
         <!--下次保养提醒 end-->
        </td>
        </tr>
        <tr>
        <td>
         <!--接待提醒 start-->
          <span style='font-weight:bold;font-size:15px;padding-top:3px;'>预约提醒:</span>
         <!--接待提醒 end-->
        </td>
        </tr>
        <tr>
        ...
        <td>
        <!--公司地址 start-->
        <table border='0' style='font-weight:bold;font-size:13px;padding-top:3px;'><td  style='width:400px;' colspan='5'>公司地址:深圳市宝安五十区宝安大道开屏路1-3号<td  style='width:150px;'  colspan='2'>电话:0755-23938888<td  style='width:150px;'  colspan='2'>传真:0755-27755230</table>
        <!--公司地址 end-->
        </td>
        </tr>
        <tr>
