...
<body>
	<table id="tbPrint" border="0" class="Noprint">
		<tr>
			<td><input type="button" value="打印结算单" onClick="javascript:show();" /></td>
		</tr>
	</table>
	<table border="0" cellpadding="0" cellspacing="0" width="700px" 
		...
		<tr>
			<td align="center"
				style="font-size: 19px; height: 96px; font-weight: bold; text-align: center;">
				<div
					style="width: 700px; height: 96px; margin: 0 auto; line-height: 96px;">
					<img src="../image/BaLuTongLogo.png"
						style="width: 96px; display: block; margin: 0 auto; float: left; padding-left: 100px;" /><span
		...
		<tr>
			<td>
				...
				<table border="0" cellpadding="0" cellspacing="0" width="100%"
					...
					<tr>
						<td rowspan="2" class="border-bottom-right-solid">客户</td>
						<td class="border-bottom-right-dotted">&nbsp;客户名称：</td>
						<td colspan="2" class="border-bottom-right-dotted">&nbsp;<s:property
								value='gongDan.txtCheZhuName' /></td>
						<td class="border-bottom-right-dotted">&nbsp;联系人：</td>
						<td colspan="2" class="border-bottom-right-dotted">&nbsp;<s:property
								value='gongDan.txtLianXiRenName' /></td>
						<td class="border-bottom-right-dotted">&nbsp;联系电话：</td>
						<td style="border-bottom: 1px dotted black;">&nbsp;<s:property
								value='gongDan.txtCheZhuTel' /></td>
					</tr>
					<tr>
						<td class="border-bottom-right-solid">&nbsp;会员级别：</td>
						<td class="border-bottom-right-solid">&nbsp;<s:property
								value='gongDan.txtHuiYuanDengJi' /></td>
						<td class="border-bottom-right-solid">&nbsp;客户地址：</td>
				...
				<table border="0" id="weiXiuList"
					...
					<s:iterator value="gongDanXiangMuLst" status="index">
						<tr>
							...
							<td>&nbsp;<s:property value="txtRemarkOmitted" /></td>
						</tr>
					</s:iterator>
				</table> <!--维修项目 end-->
			</td>
				...
				<table border="0" id="wuLiaoList"
					...
					<s:iterator value="gongDanWuLiaoLst" status="index">
						<tr>
							...
							<td>&nbsp;<s:property value="txtQty" /></td>
							<td align="right">&nbsp;<s:property value="txtPrice" /></td>
		...
		<tr>
			<td>
				...
				<table border="2" id="billHuiZong"
					style="border: 2px solid black; width: 100%; border-collapse: collapse;">
					<tr>
						<td rowspan="5">单<br />据<br />汇<br />总<br />
						</td>
		...
		<tr>
			<td>
				...
				<table border='0' style='font-weight: bold; padding-top: 3px;'>
					<tr>
						<td>投诉热线:29971491 / 18038094463</td>
					</tr>
					<tr>
						<td>公司地址:深圳市八宝安五十区海景花园一层(宝安大道与开屏路交界处)</td>
					</tr>
				</table> <!--公司地址 end-->
			</td>
		</tr>
