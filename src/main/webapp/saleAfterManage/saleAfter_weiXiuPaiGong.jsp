...
</title> <link rel="stylesheet" type="text/css" href="../style/themes/default/easyui.css" /><link rel="stylesheet" type="text/css" href="../style/themes/icon.css" /><script src="../js/frame/jquery-1.8.0.min.js" type="text/javascript"></script> <script src="../js/frame/jquery.easyui.min.js" type="text/javascript"></script> <script src="../js/frame/locale/easyui-lang-zh_CN.js" type="text/javascript"></script> <script src="../js/common.js" type="text/javascript"></script><link href="../style/common.css" rel="stylesheet" type="text/css" /><link rel="shortcut icon" href="../image/SyAuto.ico" type="image/x-icon" /><meta http-equiv="Content-Type" content="text/html; charset=UTF-8" /><meta http-equiv="X-UA-Compatible" content="IE=8" /></head>
...
<body>
    ...
    <div style="margin-left:5px;margin-top:5px;margin-right:5px;">
         ...
         <tr ondblclick=changePaiGong('b73c8a4c-3fd5-4d5c-86d5-f86ff62bcfa0')>
          ...
          <select id="weixiuzu" name="weixiuzu"
						style="width: 138px;">
							<s:iterator value="wxpgList">
								<option value="<s:property value='weixiuzuName' />"><s:property
										value='weixiuzuName' /></option>							
							</s:iterator>
					</select></td>  
           ...
           <select id="weixiuzu" name="weixiuzu"
						style="width: 138px;">
							<s:iterator value="wxpgList">
								<option value="<s:property value='zhuxiuRen' />"><s:property
										value='zhuxiuRen' /></option>							
							</s:iterator>
					</select></td>  
